...
```{r}
#Pour l'instant, je définis le seuil comme 5 fois celui de l'écart type. J'en définis un positif et un négtaif.
...
```{r}
fviz_pca_ind(pca_waveforms, label = "none", habillage = "none", geom = "point")
```
...
k_opt <- 3  # Exemple basé sur l'elbow method
